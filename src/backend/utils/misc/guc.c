...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"is_bcdb_worker", PGC_BACKEND, CLIENT_CONN,
			gettext_noop("Start a bcdb worker."),
			NULL,
			GUC_REPORT
		},
		&is_bcdb_worker,
	...
	{
		{"OEP_mode", PGC_BACKEND, CLIENT_CONN,
			gettext_noop("BCDB worker in OEP_mode."),
			NULL,
			GUC_REPORT
		},
		&OEP_mode,
...
static struct config_int ConfigureNamesInt[] =
{
	...
	{
		{"worker_id", PGC_BACKEND, CLIENT_CONN,
			gettext_noop("worker id."),
			NULL,
			GUC_REPORT
		},
		&worker_id,
